...
7. Crons are already in `vercel.json` (`/api/cron/outreach-dispatch` every
   15 min). Contact-local send window defaults to **9–20** (9 AM–8 PM).
   Vercel cron is UTC: `*/15 12-23 * * 1-5` plus `*/15 0-4 * * 2-6` so
   dispatch keeps running through 8 PM Pacific year-round (and later ET).
