...
const SYNTHETIC_CONTEXT: DraftContext = {
  ...
  jobDetails: [
    "PRIMARY ROLE TO INQUIRE ABOUT: Senior Controls Engineer, location: Charlotte, NC, comp: $140k to $170k",
    "Plant Operations Manager, location: Charlotte, NC",
  ],
  jobLocation: "Charlotte, NC",
  primaryJobTitle: "Senior Controls Engineer",
  primaryJobLocation: "Charlotte, NC",
  primaryJobSalary: "$140k to $170k",
  primaryJobBoard: "linkedin",
  focusListingId: null,
  relatedJobTitles: ["Plant Operations Manager"],
