...
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.scrape"
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.hygiene"
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.rescore"
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.presence"
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.email"
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.scrape-pm"
echo "  launchctl bootout gui/\$(id -u)/com.vexecsearch.rescore-pm"
